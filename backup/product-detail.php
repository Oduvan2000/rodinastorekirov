							...
							<div class="row">
								<div class="col-md-6 col-md-offset-3 col-sm-12 col-xs-12 slider-text">
									<div class="slider-text-inner text-center">
										<h1>О товаре</h1>
										<h2 class="bread"><span><a href="index.php">Главная</a></span> <span><a href="shop.php">Магазин</a></span> <span>О товаре</span></h2>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="row">
								<div class="col-md-5">
									<div class="product-entry">
										...
										<div class="product-img" style="background-image: url(images/<?= $row['img'] ?>);">
											<p class="tag"><span class="sale">Sale</span></p>
										</div>

										<div class="thumb-nail">
											<a href="#" class="thumb-img" style="background-image: url(images/<?= $row['img'] ?>);"></a>
								...
								<div class="col-md-7">
									<div class="desc">
										...
										<p><a href="php/addtocard.php?id=<?= $id ?>" class="btn btn-primary btn-addtocart"><i class="icon-shopping-cart"></i> Добавить в корзину</a></p>
									</div>
								</div>
							</div>
						</div>
